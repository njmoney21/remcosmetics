      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-12">
        ...
        >
          <h2 className="text-4xl md:text-7xl font-serif font-light leading-tight">
            ...
            <motion.span className="italic text-spa-nude"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-10 py-5 border-2 border-spa-nude text-spa-nude rounded-full font-medium tracking-wide flex items-center gap-3 transition-colors hover:bg-spa-nude hover:text-spa-stone"
          >
            <Calendar size={18} />
