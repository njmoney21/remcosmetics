      ...
      <div className="relative z-10 max-w-5xl w-full text-center space-y-12">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-spa-stone/70 font-light leading-relaxed">
            Experience premium facial treatments, meticulous eyelash extensions, and professional makeup artistry in a space designed for your complete relaxation.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex -space-x-4">
            ...
            <div className="pl-4 flex flex-col justify-center text-left">
              <span className="text-xs font-semibold text-spa-stone">2k+ Happy Clients</span>
              <span className="text-[10px] text-spa-stone/50 uppercase tracking-widest">Verified Results</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          <NavItem icon={<Sparkles size={20} />} label="Facial Rituals" />
          <NavItem icon={<Eye size={20} />} label="Lash & Brow" />
          <NavItem icon={<User size={20} />} label="Artist Makeup" />
          <NavItem icon={<ArrowRight size={20} />} label="SPA Members" />
        </motion.div>
      </div>
    </section>
  );
